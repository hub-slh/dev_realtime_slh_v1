...
/**
 * @Package com.slh.function.MapDeviceAndSearchMarkModelFunc
 * @Author song.lihao
 * @Date 2025/5/14 14:34
 * @description:
 */
public class MapDeviceAndSearchMarkModelFunc extends RichMapFunction<JSONObject,JSONObject> {
    ...
    public void open(Configuration parameters) throws Exception {
        connection = JdbcUtils.getMySQLConnection(
                ...
                "root",
                "root");
        String sql = "select id, category_name, search_category from dev_realtime_v1.category_compare_dic;";
