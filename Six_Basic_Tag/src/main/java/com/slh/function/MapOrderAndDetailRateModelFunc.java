...
import com.slh.bean.DimSkuInfoMsg;
...
/**
 * @Package com.slh.function.MapOrderAndDetailRateModelFunc
 * @Author song.lihao
...
public class MapOrderAndDetailRateModelFunc  extends RichMapFunction<JSONObject,JSONObject> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        String querySkuSql = "select sku_info.id as skuid,      \n" +
                ...
                "from dev_realtime_v1.sku_info              \n" +
                "join dev_realtime_v1.spu_info              \n" +
                "on sku_info.spu_id = spu_info.id       \n" +
                "join dev_realtime_v1.base_trademark        \n" +
                "on dev_realtime_v1.spu_info.tm_id = dev_realtime_v1.base_trademark.id";
